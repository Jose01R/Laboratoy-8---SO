...
QT_MOC_LITERAL(1, 8, 13), // "signalCounter"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "Counter\0signalCounter\0"
};
...
void Counter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalCounter((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Counter::signalCounter)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Counter::signalCounter(int _t1)
{
